...
<body>
	<div class="container-fluid wrapper">
		<form action="SignupServlet" method="post">
			...
			<table
				...
				<tr class="">
					<td><img class="align-center  pt-2 img-fluid"
						...
						<h2 class="name">Admin_signup</h2></td>
				</tr>
				...
				<tr class="form form-field name">
					...
					<td class="form  pt-2">EmailId <span
						class="form d-flex  pt-2 pb-3 bradius-3 "><input
							type="email" placeholder="Email@gmail.com" name="ademail"
							id="Email"></span></td>
				...
				<tr class="form form-field name">
					...
					<td class="form  pt-2">Name<span
						class="form d-flex  pt-2 pb-3 bradius-3 "><input
							type="text" placeholder="AdminName" name="adname"
							id="name"></span></td>
				...
				<tr class="form form-field name">
					<td>Password <span class="form d-flex pt-2 pb-3 bradius-3 "><input
							type="password" placeholder="password" name="adpass" id="adpass]"></span></td>
           ...
           <a href="./Admin_login.jsp">Admin_SignIn</a>
        </div>
	</div>
